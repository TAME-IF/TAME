...
* With the introduction of the **List** type, TAME does not yet have a way to preserve values that are referential across state saves in the Java and JS/Node implementation. This fix is next to tackle.
